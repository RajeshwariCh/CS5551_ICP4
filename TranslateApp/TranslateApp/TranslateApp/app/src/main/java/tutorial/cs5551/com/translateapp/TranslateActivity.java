...
public class TranslateActivity extends AppCompatActivity {
    ...
    public void logOut(View v){
        Intent redirect1 = new Intent(TranslateActivity.this ,LoginActivity.class);
    ...
    public void translateText(View v) {
        ...
        String input=MySpin.getSelectedItem().toString();
        ...
        Toast.makeText(getBaseContext(),"Selected Language is "+input,
                Toast.LENGTH_SHORT).show();
        ...
        String getURL = "https://translate.yandex.net/api/v1.5/tr.json/translate?" +
                ...
                "lang=en-" + inputstring+ "&[format=plain]&[options=1]&[callback=set]";//The API service URL
